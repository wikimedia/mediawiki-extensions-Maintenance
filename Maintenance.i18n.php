...
Comprobando les redireiciones equivocaes...',
	...
	'maintenance-checkSyntax-error-cantopen' => "Nun pue abrise'l ficheru $1",
...
У кожным радку павінна быць крынічная старонка і мэтавая старонка, падзеленыя сымбалем «|»',
	...
	'maintenance-revdelete' => 'Выдаленьне {{PLURAL:$3|1=вэрсіі|вэрсіяў}} $1 з вікі $2', # Fuzzy
...
$messages['fa'] = array(
	...
	'maintenance-header' => 'لطفاً متن زیر را برای اجرا انتخاب کنید. توصیفات کنار هر متن هستند',
	'maintenance-error-badini' => 'پوشهٔ metadata.ini یا خراب‌شده یا گم شده‌است. لطفاً افزونهٔ نگه‌داری را دوباره دانلود کنید',
	...
	'maintenance-cleanupTable-dry-run' => 'انجام یک اجرای خسته‌کننده',
	'maintenance-cleanupTable-check' => 'در حال بررسی برای عناوین بد...',
	'maintenance-cleanupTable-checkfix' => 'در حال بررسی و اصلاح عناوین بد...',
	'maintenance-cleanupTable-progress' => '$1 $2: $3% انجام شده در $4; ETA $5 [$6/$7] $8/sec <$9% updated>',
	'maintenance-cleanupTable-missingparam' => '$1: گم شدن پارامتر $2',
	'maintenance-cleanupTable-processing' => 'در حال پردازش $1...',
	'maintenance-cleanupTable-finished' => 'به پایان رسیده $1... $2 of $3 {{PLURAL:$3|ردیف|ردیف‌ها}} به روز رسانی شده',
	'maintenance-option-quiet' => 'سرکوب خروجی بدون خطا',
	'maintenance-option-globals' => 'خروجی سراسری در پایان پردازش برای اشکال زدایی',
	'maintenance-option-confirm' => 'تأیید',
	'maintenance-option-batch-size' => 'بسیاری از عملیات هر گروه، پیش‌فرض را اجرا کنید: $1',
	'maintenance-option-required' => '(اجباری)',
	'maintenance-option-optional' => '(اختیاری)',
	'maintenance-output-success' => '$1 با موفقیت اجرا شد!',
	'maintenance-output-failure' => '$1 با موفقیت اجرا نشد!',
	'maintenance-attachLatest' => 'استفاده از این فرم برای تعمیر کردن ورودی‌ها در جدول صفحه جایی که آخرین صفحه به ۰ تنظیم شده‌است',
	'maintenance-attachLatest-desc' => 'تعمیر آخرین صفحه در جدول صفحه',
	'maintenance-attachLatest-option-fix' => 'درحقیقت تعمیر کردن ورودی‌ها، به عبارتی اجرا را قطع خواهد کرد',
	'maintenance-attachLatest-output-begin' => 'به دنبال صفحاتی با آخرین صفحهٔ تنظیم شده به ۰...',
	'maintenance-attachLatest-output-notime' => '$1 $2 [[$3]] نمی‌تواند آخرین زمان بازبینی را پیدا کند؟!',
	'maintenance-attachLatest-output-norev' => '$1 $2 [[$3]] آخرین زمان $4، نمی‌تواند شناسهٔ بازبینی را پیدا کند',
	'maintenance-attachLatest-output-found' => '$1 $2 [[$3]] آخرین زمان $4، شناسهٔ بازبینی $5',
	'maintenance-attachLatest-output-done' => 'انجام شده! پردازش $1  {{PLURAL:$1|صفحه|صفحات}}.',
	'maintenance-attachLatest-output-dryrun' => 'این یک اجرای قطع شده بود؛ برای به روز رسانی با "{{int:maintenance-attachLatest-option-fix}}" آخرین صفحه دوباره اجرا کنید.',
	'maintenance-benchmarkPurge' => 'استفاده از این فرم برای امتحان اینکه چه قدر فعالیت پاکسازی اسکوئید به طول می‌انجامد',
	'maintenance-benchmarkPurge-desc' => 'محک فعالیت پاکسازی اسکوئید',
	'maintenance-benchmarkPurge-option-count' => 'چه مقدار يوآر‌ال برای تغذیه کردن اسکوئید برای پاکسازی',
	'maintenance-benchmarkPurge-error-nosquid' => 'محک پاکسازی اسکوئید کار زیادی بدون پشتیبانی اسکوئید انجام نمی‌دهد.',
	'maintenance-benchmarkPurge-output-numsquids' => '$1 اسکوئید تعریف شدهٔ {{PLURAL:$1|سرور|سرورها}} وجود دارند:',
	'maintenance-benchmarkPurge-output-trial' => '$1 {{PLURAL:$1|عنوان|عناوین}} در $2ms ($3ms هر)',
	'maintenance-changePassword' => 'استفاده از این فرم برای تغییر رمز عبور کاربر',
	'maintenance-changePassword-desc' => 'تغییر رمز عبور کاربر',
	'maintenance-changePassword-error-nouser' => 'این چنین کاربری نیست: $1',
	'maintenance-changePassword-output-set' => 'تنظیم رمز عبور برای $1',
	'maintenance-checkAutoLoader' => 'استفاده از این فرم برای انجام بررسی‌های سلامت عقل در آتولودر',
	'maintenance-checkAutoLoader-desc' => 'بررسی‌های یلامت عقل آتولودر',
	'maintenance-checkAutoLoader-output-list2' => '$1: پوشهٔ اشتباه: در $2 پیدا شد، در $3 فهرست شده',
	'maintenance-checkBadRedirects' => 'استفاده از این فرم برای دیدن اینکه اگر صفحه‌ها به عنوان تغییر جهت‌ها علامت‌گذاری شده در حقیقت تغییر جهت هستند',
	'maintenance-checkBadRedirects-desc' => 'بررسی برای تغییر جهت‌های بد',
	'maintenance-checkBadRedirects-output-header' => 'در حال آوردن تغییر جهت‌ها...',
	'maintenance-checkBadRedirects-output-found' => 'پیدا شده $1 {{PLURAL:$1|تغییر جهت|تغییر جهت‌ها}}.
در حال بررسی برای تغییر جهت‌های بد...',
	'maintenance-checkBadRedirects-output-footer' => 'انجام شد.',
	'maintenance-checkImages' => 'استفاده از این فرم برای دیدن اینکه چه صفحاتی در ویکی شما خراب شده‌اند',
	'maintenance-checkImages-desc' => 'بررسی عکس‌ها برای مشاهدهٔ اگر موجود باشند، قابل خواندن هستند، غیره',
	'maintenance-checkImages-output-noaccess' => '$1: به‌طور داخلی قابل دسترس نیست',
	'maintenance-checkImages-output-missing' => '$1: گم شده',
	'maintenance-checkImages-output-isdir' => '$1: یک دفتر راهنما است',
	'maintenance-checkImages-output-truncated' => '$1: کوتاه شده، $2 بود',
	'maintenance-checkImages-output-mismatch' => '$1: عدم تطابق اندازهٔ  دی‌بی=$2، واقعی=$3',
	'maintenance-checkImages-output-good' => 'تصاویر خوب: $1/$2',
	'maintenance-checkSyntax' => 'از این فرم برای بررسی نحوی همهٔ پوشه‌های پی‌اچ‌پی در مدیاویکی استفاده کنید',
	'maintenance-checkSyntax-desc' => 'بررسی نحوی برای همهٔ پوشه‌های پی‌اچ‌پی در مدیاویکی',
	'maintenance-checkSyntax-option-with-extensions' => 'همچنین بازگشت پوشهٔ گستره‌ها',
	'maintenance-checkSyntax-option-path' => 'مسیر خاص (پوشه یا راهنما) برای بررسی، یا با مسیر مطلق یا مرتبط با ریشهٔ این نصب مدیاویکی',
	'maintenance-checkSyntax-option-list-file' => 'فهرست پوشه‌ها یا دفتر راهنما برای بررسی',
	'maintenance-checkSyntax-option-modified' => 'بررسی فقط صفحاتی که اصلاح شدند (نیازمند مشتری خط فرمان اس‌وی‌ان)',
	'maintenance-checkSyntax-option-syntax-only' => 'برریب برای اعتبار نحو، نادیده گرفتن هشدار‌های سبک کد',
	'maintenance-checkSyntax-output-parsekit' => 'بررسی نحو (استفاده از ابزار تجزیه)',
	'maintenance-checkSyntax-output-phpl' => 'بررسی نحو ( با استفاده از پی‌اچ‌پی -ل، ممکن است مدت زیادی طول بکشد)',
	'maintenance-checkSyntax-output-footer' => 'انجام شده! پوشه‌های $1 بررسب شده، عدم موفقیت‌های $2 و هشدارهای $3 پیدا شد',
	'maintenance-checkSyntax-output-svnlist' => 'در حال بازیابی فهرست از سرنگونی...',
	'maintenance-checkSyntax-output-buildlist' => 'در حال ساختن فهرست پوشه...',
	'maintenance-checkSyntax-output-error' => 'خطا در $1 خط $2: $3',
	'maintenance-checkSyntax-output-warning' => 'هشدار در پوشهٔ $1: $2 پیدا شد',
	'maintenance-checkSyntax-error-nofile' => 'خطا: پوشه یا دفتر راهنمای $1 نمی‌تواند پیدا شود',
	'maintenance-checkSyntax-error-cantopen' => 'پرونده باز نمی‌شود $1',
	'maintenance-checkSyntax-error-svnerr' => 'خطای بازیابی فهرست از سرنگونی!',
	'maintenance-checkUsernames' => 'استفاده از این فرم برای نمایش اینکه چه نام‌های کاربری به دلیل تغییرات پیکربندی نامعتبر هستند. اگر هیچ چیزی پس از اجرای این متن فهرست نشده‌است، همهٔ نام‌های کاربری معتبر هستند',
	'maintenance-checkUsernames-desc' => 'تأیید اینکه نام‌های کاربری پایگاه داده‌ّای در واقع معتبر هستند',
	'maintenance-checkUsernames-error-notvalid' => 'نام کاربری نامعتبر: "$3" (شناسهٔ کاربری $2)',
	'maintenance-cleanupCaps' => 'استفاده از این فرم برای تعمیر صفحات خراب ناشی از اصلاح $wgCapitalLinks',
	'maintenance-cleanupCaps-desc' => 'متن برای سرمایه گذاری پاکسازی',
	'maintenance-cleanupCaps-option-namespace' => 'تعداد فضای نامی برای اجرای پاکسازی سرپوش‌ها در',
	'maintenance-cleanupCaps-output-islower' => '$1 در حال حاضر حرف کوچک است.',
	...
	'maintenance-cleanupCaps-error-noneed' => '$wgCapitalLinks بدون نیاز به پاک‌کردن پیوندهای با حروف بزرگ است.',
	...
	'maintenance-cleanupSpam-output-false' => 'تطابق غلط',
	'maintenance-cleanupSpam-output-blanking' => 'پر کردن جای خالی',
	'maintenance-cleanupSpam-output-reverting' => 'برگشت',
	'maintenance-cleanupSpam-error-invalid' => 'مشخصات نام گروه معتبر نیست: $1',
	'maintenance-cleanupSpam-error-noid' => 'خطای داخلی: هیچ صفحه‌ای برای شناسهٔ $1 نیست',
	'maintenance-clearInterwikiCache' => 'استفاده از این فرم برای پاک کردن کامل ذخیره‌گاه ویکی داخلی',
	'maintenance-clearInterwikiCache-desc' => 'پاک‌کردن همهٔ پیوندهای ویکی داخلی برای همهٔ زبان‌ها از کاشه',
	'maintenance-createAndPromote' => 'استفاده از این فرم برای ایجاد یک کاربر جدید و ارتقاء آن به سرپرست. اگر مایل به ارتقاء به مأمور دولتی به خوبی هستید، جعبهٔ مأمور دولتی را بررسی کنید',
	...
	'maintenance-createAndPromote-error-password' => 'رمز عبوری که وارد کردید با خطایی مواجه شد: $1',
	'maintenance-deleteBatch' => 'استفاده از این فرم برای حذف تودهٔ صفحات. فقط یک صفحه در هر خط بگدارید',
	'maintenance-deleteBatch-desc' => 'حذف تودهٔ صفحات',
	'maintenance-deleteRevision' => 'استفاده از این فرم برای بازبینی حذف تودهٔ صفحات. فقط یک عدد بازبینی در هر خط بگذارید',
	'maintenance-deleteRevision-desc' => 'حذف بازبینی‌ها از پایگاه اطلاعاتی',
	'maintenance-initEditCount-desc' => 'دوباره حساب کردن ویرایش حساب‌های کاربران',
	'maintenance-initSiteStats' => 'استفاده از این فرم برای محاسبهٔ مجدد آمارهای سایت، تعیین اینکه اگر می‌خواهید بازدیدهای صفحه را به خوبی دوباره حساب کنید',
	'maintenance-initSiteStats-desc' => 'دوباره حساب کردن آمارهای سایت',
	'maintenance-moveBatch' => 'استفاده از این فرم برای انتقال تودهٔ صفحات. هر خط باید یک صفحهٔ منبع تعیین کند و صفحهٔ مقصد توسط یک میله جدا شود.',
	'maintenance-moveBatch-desc' => 'صفحات انتقال توده',
	'maintenance-reassignEdits-desc' => 'ارجاع مجدد ویرایش‌ها از یک کاربر به کاربر دیگر',
	'maintenance-runJobs-desc' => 'اجرای کارها در صف کار',
	...
	'maintenance-sql' => 'استفاده از این فرم برای اجرای یک سوال اس‌کیو‌ال در پایگاه اطلاعاتی.',
	'maintenance-sql-desc' => 'اجرای یک سوال اس‌کیو‌ال',
	'maintenance-sql-option-file' => 'اس‌کیو‌ال برای اجرا',
	'maintenance-sql-output-aff' => 'پرسش صحیح است، $1 {{PLURAL:$1|ردیف|ردیف‌ها}} تحت تأثیر قرار گرفته',
	'maintenance-sql-error-cantopen' => 'قادر به باز کردن پوشهٔ‌ ورودی نیست',
	'maintenance-showCacheStats-desc' => 'نمایش آمارهای ممکچد',
	'maintenance-eval' => 'اسفاده از این فرم برای ارزیابی کد پی‌اچ‌پی در محیط مدیاویکی',
	'maintenance-eval-desc' => 'ارزیابی کد پی‌اچ‌پی در محیط مدیاویکی',
	'maintenance-update' => 'استفاده از به روز رسانی هنگام به روز رسانی یک جدول؟ بدون بررسی به جای حذف/درج استفاده می‌شود.',
	'maintenance-noviews' => 'بررسی این برای جلوگیری از به روز رسانی تعداد بازدیدهای صفحه',
	...
	'maintenance-titlenoexist' => 'عنوان تعیین شدهٔ ("$1") وجود ندارد!',
	'maintenance-failed' => 'انجام نشد',
	'maintenance-deleted' => 'حذف شده',
	'maintenance-revdelete' => 'حذف {{PLURAL:$3|بازبینی|بازبینی‌های}} $1 از ویکی $2',
	'maintenance-revnotfound' => 'بازبینی $1 پیدا نشد!',
	'maintenance-showCacheStats-edits' => 'تعداد ویرایش‌ها: $1',
	'maintenance-showCacheStats-articles' => 'تعداد صفحات در فضای نام اصلی: $1',
	'maintenance-showCacheStats-pages' => 'تعداد صفحات: $1',
	'maintenance-showCacheStats-users' => 'تعداد کاربران: $1',
	'maintenance-showCacheStats-admins' => 'تعداد ادمین‌ها:‌$1',
	'maintenance-showCacheStats-images' => 'تعداد پوشه‌ها: $1',
	'maintenance-showCacheStats-views' => 'تعداد مشاهدهٔ صفحات: $1',
	'maintenance-showCacheStats-update' => 'به روز رسانی پایگاه اطلاعاتی{{int:ellipsis}}',
	'maintenance-move' => 'حرکت $1 به $2{{int:ellipsis}}',
	'maintenance-movefail' => 'خطای مواجه شده با حرکت: $1.
حرکت ناموفق',
	'maintenance-error' => 'خطا: $1',
	'maintenance-memc-fake' => 'شما در حال اجرای FakeMemCachedClient هستید. هیچ آماری نمی‌تواند ارائه شود',
	'maintenance-memc-requests' => 'درخواست‌ها',
	'maintenance-memc-withsession' => 'با دوره:',
	...
	'maintenance-memc-stub' => ' آستانهٔ ته‌رسید:',
	'maintenance-memc-imagecache' => 'ذخیره‌گاه عکس',
	'maintenance-memc-misses' => 'از دست داده‌ها:',
...
Valmis.',
	...
	'maintenance-checkSyntax-output-error' => 'Virhe tiedoston $1 rivillä $2: $3',
...
Jokaisella rivillä tulisi olla lähdesivu ja kohdesivu pystyviivan erottamina',
	...
	'maintenance-runJobs-option-procs' => 'Käytettävien prosessien määrä',
...
כל שורה אמורה לציין דף מקור ודף יעד המופרדים ב־"|"',
	...
	'maintenance-runJobs-option-type' => 'סוג משימה להפעלה',
	'maintenance-runJobs-option-procs' => 'מספר תהליכים לשימוש',
...
Le descrizioni sono riportate a fianco di ciascuno script',
	'maintenance-error-badini' => "Il file metadata.ini è danneggiato o mancante. Per favore riscarica l'estensione Maintenance",
	...
	'maintenance-generic-password' => 'Password',
	'maintenance-generic-reason' => 'Motivo',
	'maintenance-cleanupTable-dry-run' => 'Esegui in prova',
	...
	'maintenance-option-quiet' => 'Escludi messaggi non di errore in uscita',
	'maintenance-option-confirm' => 'Conferma',
	'maintenance-option-batch-size' => 'Esegui queste operazioni in gruppo, predefinito: $1',
	...
	'maintenance-attachLatest-desc' => 'Correggi page_latest nella tabella page',
	'maintenance-attachLatest-option-fix' => 'Corregge effettivamente le registrazioni, oppure è eseguito in prova',
	'maintenance-attachLatest-output-begin' => 'Ricerca delle pagine con page_latest impostato a 0...',
	'maintenance-attachLatest-output-notime' => "$1 $2 [[$3]] non è possibile trovare l'ora dell'ultima modifica?!",
	'maintenance-attachLatest-output-norev' => "$1 $2 [[$3]] ultima modifica $4, non è possibile trovare l'id versione",
	'maintenance-attachLatest-output-found' => '$1 $2 [[$3]] ultima modifica $4, versione $5',
	'maintenance-attachLatest-output-done' => 'Fatto! Elaborate $1 {{PLURAL:$1|pagina|pagine}}.',
	'maintenance-attachLatest-output-dryrun' => 'Questa è una esecuzione di prova, rieseguire con "{{int:maintenance-attachLatest-option-fix}}" per aggiornare page_latest.',
...
Fatto.',
	...
	'maintenance-checkImages-output-truncated' => '$1: troncato, era $2',
	...
	'maintenance-cleanupCaps-output-dryrun' => '"$1" -> "$2": ESECUZIONE DI PROVA, NON SPOSTATA',
	'maintenance-cleanupSpam' => 'Utilizzare questo modulo per annullare modifiche di spam che puntano a siti esterni',
	'maintenance-cleanupSpam-output-found' => '{{PLURAL:$1|Trovata $1 voce contenete|Trovate $1 voci conteneti}} $2',
	'maintenance-cleanupSpam-output-reverting' => 'ripristino',
	'maintenance-cleanupSpam-error-invalid' => 'Nome host indicato non valido: $1',
	'maintenance-cleanupSpam-error-noid' => 'Errore interno: nessuna pagina per ID $1',
	'maintenance-clearInterwikiCache' => 'Utilizza questo modulo per svuotare completamente la cache interwiki',
	'maintenance-clearInterwikiCache-desc' => 'Cancella tutti i collegamenti interwiki per tutte le lingue dalla cache',
...
Spunta la casella burocrate se vuoi promuoverlo anche burocrate',
	...
	'maintenance-createAndPromote-output-creating' => 'Creazione e promozione di {{ns:user}}:$2...',
...
Ogni riga deve indicare una pagina di origine ed una di destinazione, separate da un pipe (|)',
	...
	'maintenance-sql-output-aff' => 'Query OK, $1 {{PLURAL:$1|riga|righe}} trovate',
...
$messages['ko'] = array(
	...
	'maintenance-error-badini' => 'metadata.ini 파일이 손상됐거나 없습니다. 유지 관리 확장 기능을 다시 내려받으십시오',
	...
	'maintenance-cleanupTable-progress' => '$1 $2: $4에서 $3% 완료; ETA $5 [$6/$7]$8/초 <$9% 업데이트 됨>',
	'maintenance-cleanupTable-missingparam' => '$1: $2 매개변수 없음',
	'maintenance-cleanupTable-processing' => '$1 작업을 처리중...',
	'maintenance-cleanupTable-finished' => '$1 완료... $3 중 $2{{PLURAL:$3|열}} 업데이트됨',
	'maintenance-option-quiet' => '오류가 아닌 결과물 숨기기',
	'maintenance-option-globals' => '디버깅을 위한 처리가 끝났을 때 전역 변수를 출력',
	'maintenance-option-confirm' => '확인',
	'maintenance-option-batch-size' => '일괄 처리당 많은 작업을 실행, 기본 값:$1',
	...
	'maintenance-attachLatest' => '이 양식을 사용하여 page_latest이 0인 문서 테이블에 있는 항목을 고치세요',
	'maintenance-attachLatest-desc' => '페이지 테이블의 page_latest 항목을 고치기',
	'maintenance-attachLatest-option-fix' => '항목을 실제로 고침, 시험적으로 실행합니다',
	'maintenance-attachLatest-output-begin' => 'page_latest을 0으로 설정하여 문서를 검색하는 중...',
	'maintenance-attachLatest-output-notime' => '$1 $2 [[$3]] 문서가 최신 판 시간을 찾을 수 없습니다?!',
	'maintenance-attachLatest-output-norev' => '$1 $2 [[$3]] 최신 시간 $4, 판 id를 찾을 수 없습니다',
	'maintenance-attachLatest-output-found' => '$1 $2 [[$3]] 최근 판 $4, 판 id $5',
	'maintenance-attachLatest-output-done' => '완료! $1개의 {{PLURAL:$1|문서}}를 처리했습니다.',
	'maintenance-attachLatest-output-dryrun' => '이것은 시험 실행입니다; page_latest를 업데이트하기 위해서 "{{int:maintenance-attachLatest-option-fix}}"를 다시 실행',
	'maintenance-benchmarkPurge' => '이 양식을 사용하여 Squid 새로 고침 함수가 얼마나 오래 가지고 있는지 테스트하기',
	'maintenance-benchmarkPurge-desc' => 'Squid 새로 고침 함수를 벤치마크 테스트하기',
	'maintenance-benchmarkPurge-option-count' => '얼마나 많은 URL을 새로 고침을 위한 Squid에 피드하는 지',
	'maintenance-benchmarkPurge-error-nosquid' => 'Squid 새로고침 벤치마크 테스트가 스퀴드를 지원하지 않고는 진행할 수 없습니다.',
	'maintenance-benchmarkPurge-output-numsquids' => '정의된 Squid {{PLURAL:$1|서버}}가 있습니다.',
	'maintenance-benchmarkPurge-output-trial' => '$2ms로(각각 $3ms) $1개의 {{PLURAL:$1|제목}}',
	'maintenance-changePassword' => '이 양식을 사용하여 사용자의 비밀번호를 바꾸세요',
	'maintenance-changePassword-desc' => '사용자의 비밀번호를 바꾸기',
	'maintenance-changePassword-error-nouser' => '해당 사용자 없음: $1',
	'maintenance-changePassword-output-set' => '$1 사용자가 비밀번호를 설정했습니다.',
	'maintenance-checkAutoLoader' => '양식을 사용하여 AutoLoader에서 온전성 검사를 수행하기',
	'maintenance-checkAutoLoader-desc' => 'AutoLoader 온전성 검사',
	'maintenance-checkAutoLoader-output-list2' => '$1: 잘못된 파일: $2에서 찾음, $3에 목록화됨',
	'maintenance-checkBadRedirects' => '양식을 사용하여 넘겨주기로 표시된 문서가 실제로 넘겨주기 문서인지 알아보기',
	'maintenance-checkBadRedirects-desc' => '끊긴 넘겨주기 검사',
	'maintenance-checkBadRedirects-output-header' => '넘겨주기를 가져오는 중...',
	'maintenance-checkBadRedirects-output-found' => '$1개의 {{PLURAL:$1|넘겨주기}} 찾음.
끊어진 넘겨주기 검사 중...',
	'maintenance-checkBadRedirects-output-footer' => '완료.',
	'maintenance-checkImages' => '이 양식을 사용하여 위키의 깨진 이미지를 보세요',
	'maintenance-checkImages-desc' => '그림을 검사하여 그림이 존재하고 읽을 수 있는지 등을 알아보기',
	'maintenance-checkImages-output-noaccess' => '$1: 로컬에서 접근 불가능',
	'maintenance-checkImages-output-missing' => '$1: 없음',
	'maintenance-checkImages-output-isdir' => '$1: 디렉터리입니다',
	'maintenance-checkImages-output-truncated' => '$1: 버림하여 $2임',
	'maintenance-checkImages-output-mismatch' => '$1: 크기가 DB=$2와 일치하지 않음, 실제=$3',
	'maintenance-checkImages-output-good' => '좋은 그림: $1/$2',
	'maintenance-checkSyntax' => '이 양식을 사용하여 미디어위키에 있는 모든 PHP 파일의 구문을 검사하세요',
	'maintenance-checkSyntax-desc' => '미디어위키의 모든 PHP 파일에 대한 구문을 검사',
	'maintenance-checkSyntax-option-with-extensions' => '또한 확장 기능 폴더를 재귀적으로 실행',
	'maintenance-checkSyntax-option-path' => '절대 경로와 이 미디어위키 설치의 상대 경로를 포함한 검사할 특정 경로(파일 또는 디렉터리)',
	'maintenance-checkSyntax-option-list-file' => '검사할 파일과 디렉터리 목록',
	'maintenance-checkSyntax-option-modified' => '수적된 파일 검사(svn 명령-줄 클라이언트가 필요)',
	'maintenance-checkSyntax-option-syntax-only' => '구문 유효성만을 검사, 스킵 코드 스타일 경고',
	'maintenance-checkSyntax-output-parsekit' => '구문 검사(parsekit 사용)',
	'maintenance-checkSyntax-output-phpl' => '구문 검사(php -l 사용, 시간이 걸릴 수 있음)',
	'maintenance-checkSyntax-output-footer' => '완료! $1 파일 검사됨, $2 실패 및 $3 경고 찾아냄',
	'maintenance-checkSyntax-output-svnlist' => '하위 버전에서 목록을 가져오는 중...',
	'maintenance-checkSyntax-output-buildlist' => '파일 목록을 구축하는 중...',
	'maintenance-checkSyntax-output-error' => '$1 파일 $2줄의 오류: $3',
	'maintenance-checkSyntax-output-warning' => '$1 파일의 경고: $2를 찾음',
	'maintenance-checkSyntax-error-nofile' => '오류: 파일 또는 $1 디렉터리를 찾을 수 없음',
	'maintenance-checkSyntax-error-cantopen' => '$1 파일을 열 수 없습니다',
	'maintenance-checkSyntax-error-svnerr' => '하위버전에서 목록을 가져오는 중 오류 발생',
	'maintenance-checkUsernames' => '사용자이름이 설정 바뀜 때문에 유효하지 않은 것을 보기 위해서는 양식을 사용하세요. 만약 스크립트를 실행하는 중 목록에 아무것도 없으면 모든 사용자이름이 유효한 것입니다.',
	'maintenance-checkUsernames-desc' => '데이터베이스 사용자이름이 실제로 유효하지 않은지 검증',
	'maintenance-checkUsernames-error-notvalid' => '유효하지 않은 사용자이름: "$3"(사용자 이름 $2)',
	'maintenance-cleanupCaps' => '$wgCapitalLinks을 수정했기 때문에 발생한 깨진 문서들을 양식을 사용하여 수정하기',
	'maintenance-cleanupCaps-desc' => '대문자화 정리 스크립트',
	'maintenance-cleanupCaps-option-namespace' => '대소문자 정리를 실행할 이름공간 수',
	'maintenance-cleanupCaps-output-islower' => '"$1" 문서 이름이 이미 소문자임.',
	'maintenance-cleanupCaps-output-clash' => '"$1" 넘어감; "$2"가 이미 존재함',
	'maintenance-cleanupCaps-output-dryrun' => '"$1" -> "$2": 시험 실행, 이동되지 않음',
	'maintenance-cleanupCaps-error-noneed' => '$wgCapitalLinks이 작동 중 -- 링크 대문자화 정리 필요 없음.',
	'maintenance-cleanupSpam' => '이 양식을 사용하여 바깥 사이트로 연결된 스팸 편집을 되돌리세요',
	'maintenance-cleanupSpam-desc' => '입력된 호스트 이름에서 모든 스팸 정리하기',
	'maintenance-cleanupSpam-option-hostname' => '스팸이었던 호스트 이름',
	'maintenance-cleanupSpam-output-found' => '$2를 포함한 $1 {{PLURAL:$1|문서}}를 찾음',
	...
	'maintenance-clearInterwikiCache' => '이 양식을 사용하여 인터위키 캐시를 완전히 지우세요',
	...
	'maintenance-createAndPromote-output-creating' => '{{ns:user}}:$2 사용자를 만들고 승격시키는 중...',
	'maintenance-createAndPromote-error-password' => '입력한 비밀번호에 오류가 발생했습니다.: $1',
	'maintenance-deleteBatch' => '이 양식을 사용하여 문서를 대량 삭제하세요. 줄당 한 문서만 넣으세요',
	'maintenance-deleteBatch-desc' => '문서 대량 삭제',
	'maintenance-deleteRevision' => '이 양식을 사용하여 판을 대량 삭제하세요. 줄당 한 판만 넣으세요',
	'maintenance-deleteRevision-desc' => '데이터베이스에서 판 제거',
	'maintenance-initEditCount-desc' => '사용자 편집 수 다시 계산하기',
	'maintenance-initSiteStats' => '이 양식을 사용해서 사이트 통계를 다시계산하고, 문서 조회수도 마찬가지로 다시 계산하려면 지정하기',
	'maintenance-initSiteStats-desc' => '사이트 통계 다시 계산하기',
	'maintenance-moveBatch' => '이 양식을 사용해서 문서를 대량 이동하세요. 각각의 줄은 출발 문서와 도착 문서를 파이프 문자로 구분하여 지정해야 합니다',
	'maintenance-moveBatch-desc' => '대량 이동 문서',
	'maintenance-reassignEdits-desc' => '한 사용자에서 다른 사용자에게 편집을 재할당',
	...
	'maintenance-runJobs-option-exclusive' => '한 번에 배타적 runJobs 스크립트를 한 번만 실행하세요. 시간 제한은 1800초입니다.',
	'maintenance-runJobs-error-invalidprocs' => '1에서 1000 사이의 프로세스를 지정해야 합니다',
	'maintenance-showJobs-desc' => '작업 대기열에서 보류 중인 작업 목록 보이기',
	'maintenance-showJobs-option-group' => '작업 유형당 작업의 수 표시',
	'maintenance-sql' => '이 양식을 사용하여 데이터베이스에서 SQL 쿼리를 실행하세요.',
	...
	'maintenance-eval' => '이 양식을 사용하여 미디어위키 환경에서 PHP 코드를 평가하세요.',
	'maintenance-eval-desc' => '미디어위키 환경에서 PHP 코드를 평가하기',
	'maintenance-update' => '테이블을 업데이트 할 때 UPDATE를 사용하시겠습니까? 체크하지 않으면 DELETE/INSERT를 사용합니다.',
	'maintenance-noviews' => '여기에 체크하여 페이지 뷰 수를 업데이트하는 것을 막기',
	...
	'maintenance-showCacheStats-images' => '플라이 수: $1',
	'maintenance-showCacheStats-views' => '페이지뷰 수: $1',
	'maintenance-showCacheStats-update' => '데이터베이스 업데이트 중{{int:ellipsis}}',
	'maintenance-move' => '$1을 $2로 옮기는 중{{int:ellipsis}}',
	'maintenance-movefail' => '옮기는 도중 오류 발생: $1
이동 중지',
	'maintenance-error' => '오류: $1',
	'maintenance-memc-fake' => 'FakeMemCachedClient가 작동하고 있습니다. 통계를 제공할 수 없습니다.',
	'maintenance-memc-requests' => '요청',
	'maintenance-memc-withsession' => '세션 있음:',
	'maintenance-memc-withoutsession' => '세션 없음:',
	'maintenance-memc-total' => '합계:',
	'maintenance-memc-parsercache' => '파서 캐시',
	'maintenance-memc-hits' => '조회 수:',
	'maintenance-memc-invalid' => '유효하지 않음:',
	'maintenance-memc-expired' => '만료됨:',
	'maintenance-memc-absent' => '없음:',
	'maintenance-memc-stub' => '토막글 임계값:',
	'maintenance-memc-imagecache' => '그림 캐시:',
	'maintenance-memc-misses' => '미스 수:',
	'maintenance-memc-updates' => '업데이트:',
	'maintenance-memc-uncacheable' => '캐시할 수 없음:',
	'maintenance-memc-diffcache' => '차이 캐시',
	'maintenance-reassignEdits' => '이 양식을 사용하여 한 사용자에게서 다른 사용자에게 편집을 다시 할당하세요.',
	'maintenance-re-from' => '편집을 할당한 사용자 이름',
	'maintenance-re-to' => '편집을 할당받은 사용자 이름',
	'maintenance-re-force' => '대상 사용자가 존재하지 않더라도 재할당하기',
	'maintenance-re-rc' => '최근 바뀜 테이블을 업데이트 하지 않음',
	'maintenance-re-report' => '바뀔 내용의 세부 사항을 출력하지만 업데이트하지 않기',
	'maintenance-re-nf' => '$1 사용자를 찾을 수 없습니다',
	'maintenance-re-rr' => '"$1"을 업데이트 하지 않고 스크립트를 다시 실행하기',
...
Jif nur eine Versionsnummer en jede Reih en.',
	...
	'maintenance-initSiteStats' => 'Met hee dämm Fommulaa kanns De Schtatistike för Sigge neu ußräschne.
Do kanns extra aanjävve, of De de Sigge-Afroofe och neu jezallt han wells.',
	'maintenance-initSiteStats-desc' => 'Donn de Sigge ier Schtatistike neu ußzälle',
...
met enem senkrääschte Shtresh dozwesche, allsu däm „|“',
	...
	'maintenance-showCacheStats-desc' => 'Zeisch de Schtatistike vum <tt>Memcached</tt>',
	...
	'maintenance-showCacheStats-pages' => 'De Aanzahl Sigge: $1',
...
Dat Ömnenne weed jeshtopp.',
	'maintenance-error' => 'Fähler: $1',
	'maintenance-memc-fake' => 'Ühr hat der <code>FakeMemCachedClient</code> am Loufe. Do jidd_et kein Schtatistike för.',
	...
	'maintenance-re-total' => 'De Aanzahl Endrähsch zom Ändere es $1.',
...
An all Linn soll en Quellsäit an eng Zilsäit, getrennt duerch een ''<nowiki>|</nowiki>'', drastoen.",
	...
	'maintenance-sql-error-cantopen' => 'Den Input-Fichier konnt net opgemaach ginn',
...
До секоја скрипта стои нејзин опис',
	...
	'maintenance-attachLatest-output-notime' => '$1 $2 [[$3]] не можете да го пронајдете времето на најновата преработка?!',
	'maintenance-attachLatest-output-norev' => '$1 $2 [[$3]] време на посл. прер.: $4. Не можам да ја пронајдам назнаката на преработката',
	'maintenance-attachLatest-output-found' => '$1 $2 [[$3]] време на најнова верзија: $4, назнака на прер.: $5',
...
Проверувам дали има лоши пренасочувања...',
	...
	'maintenance-clearInterwikiCache' => 'Послужете се со овој образец за наполно да го исчистите меѓускладот во меѓувики',
	'maintenance-clearInterwikiCache-desc' => 'Чистење на сите меѓувики-врски на сите јазици од меѓускладот',
...
Внесувајте само една страница по ред',
	...
	'maintenance-deleteRevision' => 'Овој образец служи за групно бришење на преработки.
Внесувајте само по еден број на преработка во секој ред',
	'maintenance-deleteRevision-desc' => 'Отстрани преработки од базата на податоци',
...
ВО секој ред треба да има наведено изворна страница и целна страница, одделени со знакот „|“',
	...
	'maintenance-revdelete' => 'Бришење на {{PLURAL:$3|преработка|преработки}} $1 од викито $2',
	'maintenance-revnotfound' => 'Преработката $1 не е пронајдена!',
...
$messages['ml'] = array(
	...
	'maintenance-backlink' => 'സ്ക്രിപ്റ്റുകളുടെ തിരഞ്ഞെടുക്കൽ താളിലേക്കു മടങ്ങുക',
...
Arrèst del desplaçament.',
	...
	'maintenance-memc-uncacheable' => 'fòra escondedor :',
...
As descrições estão junto a cada script',
	...
	'maintenance-cleanupTable-check' => 'A verificar títulos incorretos...',
	'maintenance-cleanupTable-checkfix' => 'A verificar e corrigir títulos incorretos...',
	'maintenance-cleanupTable-progress' => '$1 $2: $3% em $4; hora prevista para terminar $5 [$6/$7] $8/seg <$9% atualizado>',
	...
	'maintenance-checkBadRedirects' => 'Use este formulário para verificar se as páginas marcadas como redirecionamentos são realmente redirecionamentos',
	'maintenance-checkBadRedirects-desc' => 'Verificar redirecionamentos falsos',
	'maintenance-checkBadRedirects-output-header' => 'A obter lista de redirecionamentos...',
...
A procurar redirecionamentos incorretos...',
	...
	'maintenance-checkImages-output-truncated' => '$1: truncado, era $2',
	'maintenance-checkImages-output-mismatch' => '$1: incompatibilidade de tamanho BD=$2, real=$3',
	...
	'maintenance-checkSyntax-option-list-file' => 'Lista de ficheiros ou diretórios a verificar',
	...
	'maintenance-cleanupCaps-error-noneed' => '$wgCapitalLinks está ativado; não é necessário fazer a limpeza do uso de maiúsculas e minúsculas.',
...
Cada linha deverá especificar uma página de origem e uma página destino, separadas por uma barra vertical "|".',
	...
	'maintenance-sql-option-file' => 'SQL a executar',
	'maintenance-sql-output-aff' => 'Consulta correta, $1 {{PLURAL:$1|linha afetada|linhas afetadas}}',
...
As descrições estão junto a cada script',
	...
	'maintenance-option-optional' => '(opcional)',
	'maintenance-output-success' => '$1 executado com sucesso!',
	'maintenance-changePassword' => 'Use este formulário para alterar a senha de um usuário',
	'maintenance-changePassword-desc' => 'Alterar a senha de um usuário',
	'maintenance-checkBadRedirects-output-footer' => '
Feito.',
	'maintenance-createAndPromote' => 'Utilize este formulário para criar um novo utilizador e promovê-lo a administrador.
Assinale a caixa de burocrata se pretende também promovê-lo a burocrata',
...
Cada linha deverá especificar uma página fonte e uma página destino, separadas por uma barra vertical ("pipe")',
	...
	'maintenance-showCacheStats-users' => 'Número de utilizadores: $1',
	'maintenance-showCacheStats-admins' => 'Número de administradores: $1',
	'maintenance-showCacheStats-images' => 'Número de arquivos: $1',
...
Проверяются неверные перенаправления...',
	...
	'maintenance-cleanupSpam-error-invalid' => 'Недопустимая спецификация имени узла: $1',
...
Beskrivningar finns brevid varje skript',
	...
	'maintenance-cleanupTable-check' => 'Söker efter dåliga titlar...',
	'maintenance-cleanupTable-checkfix' => 'Söker och korrigerar dåliga titlar...',
	'maintenance-cleanupTable-missingparam' => '$1: Saknad parameter $2',
	'maintenance-cleanupTable-processing' => 'Bearbetar $1...',
	'maintenance-cleanupTable-finished' => 'Färdig $1... $2 av $3 {{PLURAL:$3|rad uppdaterad|rader uppdaterade}}',
	...
	'maintenance-output-failure' => '$1 kördes inte framgångsrikt!',
	...
	'maintenance-changePassword-output-set' => 'Lösenord satt för $1',
	'maintenance-checkAutoLoader-output-list2' => '$1: Felaktig fil: funnen i $2, listad i $3',
...
Letar efter dåliga omdirigeringar...',
	'maintenance-checkBadRedirects-output-footer' => '
Färdig.',
	'maintenance-checkImages-desc' => 'Kolla är bilderna för att se om de existerar, är lättlästa, etc.',
	'maintenance-checkImages-output-noaccess' => '$1: inte tillgängliga lokalt',
	'maintenance-checkImages-output-missing' => '$1: saknas',
	'maintenance-checkImages-output-isdir' => '$1: är en katalog',
	'maintenance-checkImages-output-mismatch' => '$1: avvikande storlek DB=$2, faktisk=$3',
	'maintenance-checkImages-output-good' => 'Bra bilder: $1/$2',
	'maintenance-checkSyntax' => 'Använd detta formulär för att kontrollera syntaxen för alla PHP-filer i MediaWiki',
	'maintenance-checkSyntax-desc' => 'Kontrollera syntax för alla PHP-filer i MediaWiki',
	'maintenance-checkSyntax-option-list-file' => 'Lista över filer eller kataloger att kontrollera',
	'maintenance-checkSyntax-option-modified' => 'Kontrollera endast filer som har ändrats (kräver svn kommandoradsklienten)',
	'maintenance-checkSyntax-output-footer' => 'Klart! $1 filer kontrollerade, $2 misslyckanden och $3 varningar hittade',
	'maintenance-checkSyntax-output-buildlist' => 'Bygger fillista',
	'maintenance-checkSyntax-output-error' => 'Fel i $1 rad $2: $3',
	'maintenance-checkSyntax-output-warning' => 'Varning i fil $1: $2 hittade',
	'maintenance-checkSyntax-error-nofile' => 'Fel: kan inte hitta fil eller katalog $1',
	'maintenance-checkSyntax-error-cantopen' => 'Kan inte öppna fil $1',
	'maintenance-checkUsernames-error-notvalid' => 'Ogiltigt användarnamn: "$3" (användar-id $2)',
	'maintenance-cleanupCaps-desc' => 'Skript för att rensa skrivning med stora bokstäver',
	'maintenance-cleanupCaps-output-islower' => '"$1" är redan i gemener.',
	'maintenance-cleanupCaps-output-clash' => '"$1" hoppades över; "$2" finns redan',
	'maintenance-cleanupSpam-desc' => 'Rensa alla spam från ett givet värddatornamn',
	'maintenance-cleanupSpam-option-hostname' => 'Värddatornamn som spammade',
	'maintenance-cleanupSpam-output-found' => 'Hittade $1 {{PLURAL:$1|artikel|artiklar}} som innehåller $2',
	'maintenance-cleanupSpam-output-false' => 'Falsk träff',
	'maintenance-cleanupSpam-output-reverting' => 'återställer',
	'maintenance-cleanupSpam-error-invalid' => 'Inte ett giltigt värddatornamnsspecifikation: $1',
	'maintenance-cleanupSpam-error-noid' => 'Internt fel: ingen sida för ID $1',
	'maintenance-clearInterwikiCache' => 'Använd detta formulär för att helt rensa interwiki-cachen',
	'maintenance-clearInterwikiCache-desc' => 'Rensa alla interwikilänkar för alla språk från cachen',
...
Kryssa i byråkratruta om du vill befodra den till byråkrat istället',
	...
	'maintenance-createAndPromote-error-password' => 'Ett fel uppstod med det lösenord du angav: $1',
...
Varje rad specifierar den nuvarande sidan och destinationssidan separerade med ett lodrätt streck (|)',
	...
	'maintenance-runJobs-option-maxjobs' => 'Maximalt antal jobb att köra',
	'maintenance-runJobs-option-type' => 'Typ av jobb som ska köras',
	'maintenance-runJobs-option-procs' => 'Antal processer att använda',
	'maintenance-runJobs-error-invalidprocs' => 'Du måste ange mellan 1 och 1 000 processer',
	'maintenance-showJobs-desc' => 'Visa en lista över jobb som ligger i jobbkön',
	'maintenance-showJobs-option-group' => 'Visa antal jobb per jobbtyp',
	'maintenance-sql' => 'Använd detta formulär för att köra en SQL-fråga mot databasen.',
	'maintenance-sql-desc' => 'Kör SQL-fråga',
	'maintenance-sql-error-cantopen' => 'Det går inte att öppna indatafilen',
...
Katabi ng bawat panitik ang mga paglalarawan',
	...
	'maintenance-changePassword' => 'Gamitin ang form na ito upang baguhin ang password ng isang tagagamit',
...
$messages['uk'] = array(
	...
	'maintenance-attachLatest-output-found' => '$1 $2 [[$3]] остання зміна $4, номер версії $5',
	'maintenance-attachLatest-output-done' => 'Зроблено! Опрацьовано $1 {{PLURAL:$1|сторінку|сторінки|сторінок}}.',
	'maintenance-attachLatest-output-dryrun' => 'Це був тестовий запуск; запустіть знову з "{{int:maintenance-attachLatest-option-fix}}" для оновлення page_latest.',
	'maintenance-benchmarkPurge' => 'Використовуйте цю форму, щоб перевірити, скільки часу піде на функції очищення Squid',
	'maintenance-benchmarkPurge-desc' => 'Вимірювання швидкості функцій очищення Squid',
	'maintenance-benchmarkPurge-option-count' => 'Скільки URL-адрес потрібно для очищення Squid',
	'maintenance-benchmarkPurge-error-nosquid' => 'Вимірювання швидкості очищення Squid не працює без підтримки Squid',
	'maintenance-benchmarkPurge-output-numsquids' => '$1 {{PLURAL:$1|визначений сервер Squid|визначені сервери Squid|визначених серверів Squid}}:',
	'maintenance-benchmarkPurge-output-trial' => '$1 {{PLURAL:$1|заголовок|заголовки|заголовків}} за $2мс ($3мс кожний)',
	'maintenance-changePassword' => 'Використовуйте цю форму, аби змінити пароль учасника',
	'maintenance-changePassword-desc' => 'Змінити пароль користувача',
	'maintenance-changePassword-error-nouser' => 'Немає такого користувача: $1',
	'maintenance-changePassword-output-set' => 'Пароль для $1 встановлено',
	'maintenance-checkAutoLoader' => 'Використовуйте цю форму для перевірок справності AutoLoader',
	'maintenance-checkAutoLoader-desc' => 'Перевірка справності AutoLoader',
	'maintenance-checkAutoLoader-output-list2' => '$1: невірний файл: знайдено у $2, вказано у $3',
	'maintenance-checkBadRedirects' => 'Використовуйте цю форму, щоб переконатися, чи сторінки з позначкою перенаправлення справді є перенаправленнями',
	'maintenance-checkBadRedirects-desc' => 'Пошук невірних перенаправлень',
	'maintenance-checkBadRedirects-output-header' => 'Вибірка перенаправлень...',
	'maintenance-checkBadRedirects-output-found' => 'Знайдено {{PLURAL:$1|$1 перенаправлення|$1 перенаправлення|$1 перенаправлень}}.
Перевірка на невірні перенаправлення...',
	'maintenance-checkBadRedirects-output-footer' => 'Готово.',
	'maintenance-checkImages' => 'Використовуйте цю форму, аби побачити, які зображення пошкоджені на Вашій вікі',
	'maintenance-checkImages-desc' => 'Перевірка зображень на існування, читабельність і т.д.',
	'maintenance-checkImages-output-noaccess' => '$1: локально недоступне',
	'maintenance-checkImages-output-missing' => '$1: відсутнє',
	'maintenance-checkImages-output-isdir' => '$1 - каталог',
	'maintenance-checkImages-output-truncated' => '$1: обрізано, було $2',
	'maintenance-checkImages-output-mismatch' => '$1: невідповідність розмірів БД=$2, фактична=$3',
	'maintenance-checkImages-output-good' => 'Гарні зображення: $1/$2',
	'maintenance-checkSyntax' => 'Використовуйте цю форму для перевірки синтаксису всіх PHP-файлів у Медіавікі.',
	'maintenance-checkSyntax-desc' => 'Перевірити синтаксис для всіх PHP файлів у Медіавікі',
	'maintenance-checkSyntax-option-with-extensions' => 'Також рекурсивно теку розширень',
	'maintenance-checkSyntax-option-path' => 'Конкретний шлях (до файлу або каталогу) для перевірки може бути абсолютним або відносним стосовно кореня цієї установки Медіавікі',
	'maintenance-checkSyntax-option-list-file' => 'Список файлів або каталогів для перевірки',
	'maintenance-checkSyntax-option-modified' => 'Перевірити тільки змінені файли (потрібний клієнт SVN для командного рядка)',
	'maintenance-checkSyntax-option-syntax-only' => 'Перевірити тільки синтаксис, пропускати попередження про стилі коду',
	'maintenance-checkSyntax-output-parsekit' => 'Перевірка синтаксису (з використанням parsekit)',
	'maintenance-checkSyntax-output-phpl' => 'Перевірка синтаксису (з використанням php-l, це може зайняти тривалий час)',
	'maintenance-checkSyntax-output-footer' => 'Готово! Перевірено файлів: $1. Збоїв: $2. Попередження: $3.',
	'maintenance-checkSyntax-output-svnlist' => 'Отримання списку з Subversion...',
	...
	'maintenance-checkSyntax-output-warning' => 'Попередження у файлі  $1: знайдено $2',
	...
	'maintenance-checkSyntax-error-svnerr' => 'Помилка при отриманні списку з Subversion!',
	'maintenance-checkUsernames' => 'Використовуйте цю форму, щоб вивести імена учасників, які стали недійсними через зміну конфігурації. Якщо після запуску сценарію список залишиться порожній, то усі імена є дійсними.',
	'maintenance-checkUsernames-desc' => 'Перевірка дійсності імен користувачів бази даних',
	'maintenance-checkUsernames-error-notvalid' => "Неправильне ім'я користувача: „$3“ (ідентифікатор користувача  $2)",
	'maintenance-cleanupCaps' => 'Використовуйте цю форму, аби виправити непрацюючі сторінки, зіпсовані змінами $wgCapitalLinks',
	'maintenance-cleanupCaps-desc' => 'Сценарій для очищення переведення у великі літери',
	'maintenance-cleanupCaps-option-namespace' => 'Номер простору імен для виконання очищення великих літер',
	'maintenance-cleanupCaps-output-islower' => '" $1 " вже в нижньому регістрі.',
	'maintenance-cleanupCaps-output-clash' => '"$1" пропущено; "$2" вже існує',
	'maintenance-cleanupCaps-output-dryrun' => '„$1“ → „$2“: ПРОБНИЙ ПУСК, НЕ ПЕРЕЙМЕНОВАНА',
	'maintenance-cleanupCaps-error-noneed' => '$wgCapitalLinks увімкнено - нема потреби у очищенні посилань з великими літерами',
	'maintenance-cleanupSpam' => 'Використовуйте цю форму, щоб повернути спамерські зміни, які посилаються на зовнішні сайти',
	'maintenance-cleanupSpam-desc' => 'Очистити увесь спам від даного вузлу',
	'maintenance-cleanupSpam-option-hostname' => 'Назва вузла, який спамив',
	'maintenance-cleanupSpam-output-found' => 'Знайдено $1 {{PLURAL:$1|статтю, яка|статті, які|статей, які}} містять $2',
	'maintenance-cleanupSpam-output-false' => 'Помилковий збіг',
	'maintenance-cleanupSpam-output-blanking' => 'очищення',
	'maintenance-cleanupSpam-output-reverting' => 'повернення',
	'maintenance-cleanupSpam-error-invalid' => 'Недопустима специфікація назви вузла: $1',
	'maintenance-cleanupSpam-error-noid' => 'Внутрішня помилка: немає сторінки з ID$1',
	'maintenance-clearInterwikiCache' => 'Використовуйте цю форму, щоб повністю очистити кеш інтервікі',
	'maintenance-clearInterwikiCache-desc' => 'Очистити всі інтервікі-посилання на всі мови з кешу',
	'maintenance-createAndPromote' => 'Використовуйте цю форму для створення нового користувача з правами адміністратора.
Зверніть увагу на форму бюрократа, якщо ви хочете зробити його бюрократом',
	'maintenance-createAndPromote-desc' => 'Створити користувача зі статусом адміністратора',
	'maintenance-createAndPromote-option-bureaucrat' => 'Дати користувачу права бюрократа',
	'maintenance-createAndPromote-output-creating' => 'Створення і просування {{ns:user}}: $2...',
	'maintenance-createAndPromote-error-password' => 'Трапилася помилка з введеним вами паролем: $1',
	'maintenance-deleteBatch' => 'Використовуйте цю форму для масового вилучення сторінок. Покладіть по одній сторінці в кожному рядку',
	'maintenance-deleteBatch-desc' => 'Масове вилучення сторінок',
	'maintenance-deleteRevision' => 'Використовуйте цю форму для масового вилучення версій. Розмістіть по одному номеру версії у рядку',
	'maintenance-deleteRevision-desc' => 'Вилучити версії з бази даних',
	'maintenance-initEditCount-desc' => 'Перерахувати кількість редагувань користувачів',
	'maintenance-initSiteStats' => 'Використовуйте цю форму для перерахунку статистики сайту, при необхідності вкажіть, що потрібно також перераховувати перегляди сторінок',
	'maintenance-initSiteStats-desc' => 'Перерахувати статистику сайту',
	'maintenance-moveBatch' => 'Використовуйте цю форму для масового перейменування сторінок.
Кожен рядок повинен містити вихідну сторінку та її нову назву, розділені знаком «|»',
	'maintenance-moveBatch-desc' => 'Масове переміщення сторінок',
	...
	'maintenance-runJobs-option-type' => 'Тип завдання для виконання',
	'maintenance-runJobs-option-procs' => 'Кількість процесів для використання',
	'maintenance-runJobs-option-exclusive' => 'Одночасно можна виконувати тільки один винятковий сценарій runJobs. Час виконання становить 1800 секунд.',
	...
	'maintenance-update' => 'Використовувати UPDATE для оновлення таблиці? Зніміть позначку для використання DELETE/INSERT.',
	'maintenance-noviews' => 'Перевірте це для запобігання поновлення переглядів',
	...
	'maintenance-failed' => 'ПОМИЛКА',
	'maintenance-deleted' => 'ВИЛУЧЕНО',
	'maintenance-revdelete' => 'Вилучення {{PLURAL:$3|1=версії|версій}} $1 із вікі $2',
	...
	'maintenance-move' => 'Переміщення  $1  у  $2 {{int:ellipsis}}',
	'maintenance-movefail' => 'Помилка сталася при переміщенні: $1.
Переривання переміщення',
	'maintenance-error' => 'Помилка: $1',
	'maintenance-memc-fake' => 'Ви працюєте в FakeMemCachedClient. Жодна статистика не надана',
	'maintenance-memc-requests' => 'Запити',
	'maintenance-memc-withsession' => 'з сесією:',
	'maintenance-memc-withoutsession' => 'без сесії:',
	...
	'maintenance-memc-expired' => 'протерміноване:',
	'maintenance-memc-absent' => 'відсутніх:',
	'maintenance-memc-stub' => 'поріг заглушок:',
	'maintenance-memc-imagecache' => 'Кеш зображень',
	'maintenance-memc-misses' => 'помилок:',
	'maintenance-memc-updates' => 'оновлень:',
	'maintenance-memc-uncacheable' => 'некешовані:',
	'maintenance-memc-diffcache' => 'Кеш різниці',
	'maintenance-reassignEdits' => 'Використовуйте цю форму, аби повторно призначити редагування від одного користувача до іншого.',
	'maintenance-re-from' => "Ім'я користувача, правки якого потрібно призначити",
	'maintenance-re-to' => "Ім'я користувача, правки якому призначають",
	'maintenance-re-force' => 'Перепризначити навіть якщо цільовий користувач не існує',
	'maintenance-re-rc' => 'Не оновлювати таблицю останніх змін',
	'maintenance-re-report' => 'Роздрукувати докладна інформація про зміни, але не виконувати їх',
	'maintenance-re-nf' => 'Користувача $1 не знайдено',
	'maintenance-re-rr' => 'Запустити сценарій знову без "$1" для оновлення.',
	'maintenance-re-ce' => 'Поточні редагування: $1',
	'maintenance-re-de' => 'Вилучені редагування: $1',
	'maintenance-re-rce' => 'Записи останніх правок: $1',
	'maintenance-re-total' => 'Всього записів для зміни: $1',
	'maintenance-re-re' => 'Перепризначення  правок {{int:ellipsis}} готове',
);
...
$messages['zh-hans'] = array(
	...
	'maintenance-header' => '请选择下面的脚本执行。说明在每个脚本旁边',
	...
	'maintenance-option-globals' => '处理结束时输出全局变量以便调试',
	...
	'maintenance-attachLatest' => '使用此表单修复page表中条项的page_latest为0的问题',
	'maintenance-attachLatest-desc' => '修复page表中条项的page_latest',
	'maintenance-attachLatest-option-fix' => '实际修复项目，否则将试运行',
	'maintenance-attachLatest-output-begin' => '寻找page_latest设置为0的页面...',
	'maintenance-attachLatest-output-notime' => '$1$2[[$3]]无法找到最新校正时间？？？',
	'maintenance-attachLatest-output-norev' => '$1 $2 [[$3]]最后一次$4，无法找到修订ID',
	'maintenance-attachLatest-output-found' => '$1 $2 [[$3]]最后一次$4，修订ID$5',
...
完成。',
	...
	'maintenance-checkUsernames-desc' => '验证数据库用户名真实有效',
	'maintenance-checkUsernames-error-notvalid' => '无效的使用者名：「$3 」（使用者id  $2 ）',
	'maintenance-cleanupCaps' => '使用此表单可以修复因修改$wgCapitalLinks导致的损坏页面',
	...
	'maintenance-cleanupSpam-output-found' => '发现$1个条目包含$2',
	'maintenance-cleanupSpam-output-false' => '错误匹配',
	'maintenance-cleanupSpam-output-blanking' => '正在清空',
	'maintenance-cleanupSpam-output-reverting' => '正在回退',
	'maintenance-cleanupSpam-error-invalid' => '不是有效格式的主机名：$1',
	'maintenance-cleanupSpam-error-noid' => '内部错误: 没有ID$1的页面',
	'maintenance-clearInterwikiCache' => '使用此表单可以完全清除跨维基缓存',
	'maintenance-clearInterwikiCache-desc' => '从缓存清除所有语言的所有跨维基链接',
	'maintenance-createAndPromote-desc' => '创建用户并赋予管理员权限',
	'maintenance-createAndPromote-option-bureaucrat' => '赋予用户行政员权限',
	'maintenance-createAndPromote-output-creating' => '正在创建并提升{{ns:user}}:$2...',
...
终止移动',
	...
	'maintenance-memc-withsession' => '带会话：',
	'maintenance-memc-withoutsession' => '不带会话：',
...
$messages['zh-hant'] = array(
	...
	'maintenance-cleanupTable-progress' => '$1 $2：於$4完成$3%；ETA $5 [$6/$7] $8/sec<$9% 已更新>',
	...
	'maintenance-attachLatest-output-notime' => '$1 $2 [[$3]]無法找到最新校正時間？！',
	'maintenance-attachLatest-output-norev' => '$1 $2 [[$3]]最新時間$4，無法找到修訂id',
	'maintenance-attachLatest-output-found' => '$1 $2 [[$3]]最新時間$4，修訂id$5',
	'maintenance-attachLatest-output-done' => '完成！已處理$1個頁面。',
	'maintenance-attachLatest-output-dryrun' => '此為試運行；通過「{{int:maintenance-attachLatest-option-fix}}」重新運行以更新page_latest。',
	...
	'maintenance-checkAutoLoader-output-list2' => '$1：錯誤檔案：於$2發現并於$3列出',
...
完成。',
	...
	'maintenance-cleanupCaps-output-dryrun' => '「$1」->「$2」試運行期間不會移動',
	'maintenance-cleanupSpam-output-false' => '錯誤匹配',
	'maintenance-cleanupSpam-output-blanking' => '正在清空',
	'maintenance-cleanupSpam-output-reverting' => '正在回退',
	...
	'maintenance-memc-withsession' => '帶會話：',
	'maintenance-memc-withoutsession' => '不帶會話：',
