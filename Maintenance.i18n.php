...
Le descrission a son tacà a minca senari",
	...
	'maintenance-createAndPromote-desc' => "Crea n'utent e promeuvlo a aministrador",
	'maintenance-deleteBatch-desc' => 'Scansela pàdine a bocc',
	'maintenance-deleteRevision-desc' => 'Gava revision dal database',
	'maintenance-eval-desc' => "Valuta còdes PHP ant l'ambient MediaWiki",
	...
	'maintenance-runJobs-desc' => 'Fà giré ij job ant la coa dij job',
	'maintenance-showJobs-desc' => 'Mosta na lista dij job pëndent ant la coa dij job',
	'maintenance-sql-desc' => 'Fà na query SQL',
	'maintenance-stats-desc' => 'Mosta statìstiche Memcached',
	'maintenance-changePassword' => 'Dòvra sta forma-sì për cangé na ciav utent',
	'maintenance-createAndPromote' => "Dòvra sta forma-sì për creé un neuv utent e promeuvlo aministrador.
Marca la casela mangiapapé s'it veule ëdcò promeuvlo a mangiapapé",
	'maintenance-deleteBatch' => 'Dòvra sta forma-sì për scanselé pàgine a bocc.
Buta mach na pàgina për linia',
	'maintenance-deleteRevision' => 'Dòvra sta forma-sì për scanselé revision a bocc.
Buta mach un nùmer ëd revision për linia',
	'maintenance-initStats' => "Dòvra sta forma-sì për torna calcolé statìstiche dël sit, spessificand s'it veule ëdcò torna calcolé le vìsite dle pàgine",
	'maintenance-moveBatch' => 'Dòvra sta forma-sì për tramudé pàgine a bocc.
Minca linia a dovrìa spessifiché na pàgina srziss e na pàgina destinassin separà da na pipe',
	'maintenance-invalidtype' => 'Sòrt pa bon!',
	...
	'maintenance-update' => 'Dovré UPDATE an modificand na tàula? Pa marcà a dòvro anvece DELETE/INSERT.',
	'maintenance-noviews' => 'Marco sòn sì për pa modifiché ël nùmer ëd vìsite dle pàgine',
	'maintenance-confirm' => 'Conferma',
	...
	'maintenance-titlenoexist' => 'Ël tìtol spessifià ("$1") a esit pa!',
	'maintenance-failed' => 'FALÌ',
	'maintenance-deleted' => 'SCANSELÀ',
	'maintenance-revdelete' => 'Scanselé {{PLURAL:$3|revision|revision}} $1 da wiki $2',
	'maintenance-revnotfound' => 'Revision $1 pa trovà!',
	'maintenance-sql' => 'Dòvra sta forma-sì për fé na query SQL an sël database.',
	'maintenance-sql-aff' => 'Righé tocà: $1',
...
$2',
	...
	'maintenance-stats-admins' => "Nùmer d'aministrador: $1",
	'maintenance-stats-images' => 'Nùmer ëd file: $1',
	'maintenance-stats-views' => 'Nùmer ëd vìsite ëd pàgine: $1',
	'maintenance-stats-update' => 'Modifiché database{{int:ellipsis}}',
	'maintenance-move' => 'Bogé $1 a $2{{int:ellipsis}}',
	'maintenance-movefail' => 'Eror ancontrà an tramudand: $1.
tramuda abortìa',
	'maintenance-error' => 'Eror: $1',
	'maintenance-memc-fake' => 'I të stas fasend giré FakeMemCachedClient. Pa gnun-e statìstiche a peule esse dàite',
	'maintenance-memc-requests' => 'Arceste',
	'maintenance-memc-withsession' => 'con session:',
	'maintenance-memc-withoutsession' => 'sensa session:',
	'maintenance-memc-total' => 'total:',
	'maintenance-memc-parsercache' => 'Cache dël parser',
	'maintenance-memc-hits' => 'colp:',
	'maintenance-memc-invalid' => 'pa bon:',
	'maintenance-memc-expired' => 'spirà:',
	'maintenance-memc-absent' => 'assent:',
	'maintenance-memc-stub' => 'livel dë sbòss:',
	'maintenance-memc-imagecache' => 'Cache figure',
	'maintenance-memc-misses' => 'mancant:',
	'maintenance-memc-updates' => 'modificà:',
	'maintenance-memc-uncacheable' => 'pa da cache:',
	'maintenance-memc-diffcache' => 'Cache dle diferense',
	'maintenance-eval' => "Dòvra sta forma-sì për valuté còdes PHP ant l'ambient WikiMedia.",
	'maintenance-reassignEdits' => "Dòvra sta forma-sì për riassigné modìfiche da n'utent a n'àutr.",
	'maintenance-re-from' => "Nòm ëd l'utent da doa pijé modìfiche",
	'maintenance-re-to' => "Nòm ëd l'utent dova assigné modìfiche",
	'maintenance-re-force' => "Riassigné ëdcò se l'utent dëstinatari a esist pa",
	'maintenance-re-rc' => 'Modìfica pa la tàula dij cambe ressent',
	'maintenance-re-report' => "Mosta ij detaj ëd lòn ch'a sarìa cangià, ma modificlo pa",
	'maintenance-re-nf' => 'Utent $1 pa trovà',
	'maintenance-re-rr' => 'Fa giré torna lë script sensa "$1" për modifiché.',
	'maintenance-re-ce' => 'Modìfiche corente: $1',
	'maintenance-re-de' => 'Modìfiche scanselà: $1',
	'maintenance-re-rce' => 'Vos an RecentChanges: $1',
	'maintenance-re-total' => 'Vos totaj da cangé: $1',
	'maintenance-re-re' => 'Riassegnassion modìfiche{{int:ellipsis}} fàita',
);
