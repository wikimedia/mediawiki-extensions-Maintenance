...
$messages['ja'] = array(
	...
	'maintenance-attachLatest-output-done' => '完了しました! $1 件のページを処理しました。',
...
Поред сваке скрипте се налази одговарајући опис.',
	...
	'maintenance-cleanupTable-check' => 'Проверавам неисправне наслове…',
	'maintenance-cleanupTable-checkfix' => 'Проверавам и исправљам погрешне наслове…',
	'maintenance-cleanupTable-processing' => 'Обрађујем $1…',
	'maintenance-option-confirm' => 'Потврди',
	...
	'maintenance-output-failure' => '$1 није успешно извршен!',
	...
	'maintenance-checkBadRedirects-desc' => 'Претражи неисправна преусмерења',
