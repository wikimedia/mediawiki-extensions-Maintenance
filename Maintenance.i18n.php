...
$messages['en'] = array(
	...
	'maintenance-checkBadRedirects-desc' => 'Look for bad redirects',
	'maintenance-checkBadRedirects-output-header' => 'Fetching redirects...',
	'maintenance-checkBadRedirects-output-found' => "Found \$1 total redirects.\nLooking for bad redirects...\n", #$1=number of redirects
...
Opisi su navedeni pored svake skripte',
	'maintenance-error-invalidtype' => 'Nevaljan tip!',
...
Die jeweiligen Beschreibungen sind neben jedem Skript angegeben.',
	...
	'maintenance-attachLatest-desc' => 'Korrektur der Einträge zu „page_latest“ in den Seitentabellen',
...
Kreuze das Auswahlkästchen Bürokrat an, sofern er auch zum Bürokraten gemachte werden soll.',
	...
	'maintenance-createAndPromote-option-bureaucrat' => 'Ein Benutzerkonto den Status Bürokrat geben',
...
Je Zeile eine durch einen senkrechten Strich („|“) getrennte Quell- sowie Zielseite angeben.',
	...
	'maintenance-runJobs-option-exclusive' => 'Das runJobs-Skript nur einzeln ausführen. Die darauf folgende Unterbrechung beträgt 1800 Sekunden.',
...
Donn dat Zohsatzprojramm <code lang="en">Maintenance</code> norr_ens neu eronger laade.',
	...
	'maintenance-cleanupTable-progress' => '$1 $2: $3% op $4 jedonn; bruch wall noch $5 [$6/$7] $8 pro Sekund <$9% aanjepaß>',
	...
	'maintenance-output-success' => '„$1“ es met Erfolch jeloufe!',
	'maintenance-attachLatest-output-done' => 'Fäädesch. {{PLURAL:$1|Ein Sigg|$1 Sigge|Kein Sigg}} beärbeidt.',
...
met enem senkrääschte Shtresh dozwesche, allsu däm „|“',
	...
	'maintenance-runJobs-desc' => 'Opjaave uß de Leß aanshtüße, dat se jetz jedonn wääde',
...
D'Beschreiwunge stinn niewent all Script.",
	'maintenance-error-invalidtype' => 'Typ net valabel!',
...
A procurar redireccionamentos incorrectos...',
	...
	'maintenance-checkSyntax-output-error' => 'Erro $1 na linha $2: $3',
	...
	'maintenance-checkUsernames-error-notvalid' => 'Nome de utilizador inválido: "$3" (id do utilizador $2)',
...
Описание рядом с каждым скриптом',
	'maintenance-error-invalidtype' => 'Ошибочный тип!',
...
Pored svake skripte se nalazi odgovarajući opis.',
	'maintenance-error-invalidtype' => 'Nepoznat tip!',
	'maintenance-option-confirm' => 'Potvrdi',
...
Katabi ng bawat panitik ang mga paglalarawan',
	'maintenance-error-invalidtype' => 'Hindi tanggap na uri!',
