...
$messages['ko'] = array(
	...
	'maintenance-attachLatest' => '이 양식을 사용하여 page_latest이 0으로 설정된 항목을 고치기',
	...
	'maintenance-changePassword' => '양식을 사용하여 사용자의 비밀번호를 바꾸기',
...
끊어진 넘겨주기 검사 중...',
	...
	'maintenance-checkImages' => '이 양식을 사용하여 위키의 깨진 이미지를 보기',
	...
	'maintenance-checkSyntax' => '이 양식을 사용하여 미디어위키의 모든 PHP의 구문을 검사',
	...
	'maintenance-cleanupSpam' => '이 양식을 사용하여 외부 사이트로 연결된 스팸 편집을 되돌리기',
	...
	'maintenance-deleteBatch' => '이 양식을 사용해서 문서를 대량삭제하세요. 줄당 한 페이지만 넣으세요',
	'maintenance-deleteBatch-desc' => '문서 대량 삭제',
	'maintenance-deleteRevision' => '이 양식을 사용해서 판을 대량 삭제하세요. 줄당 한 판만 넣으세요',
	'maintenance-deleteRevision-desc' => '데이터베이스에서 판 제거',
	'maintenance-initEditCount-desc' => '사용자 편집 수 다시 계산하기',
	'maintenance-initSiteStats' => '이 양식을 사용해서 사이트 통계를 다시계산하고, 페이지뷰도 마찬가지로 다시계산하려면 지정하기',
	...
	'maintenance-sql' => '이 양식을 사용하여 데이터베이스의 SQL 쿼리 실행',
...
이동 중지',
	...
	'maintenance-reassignEdits' => '이 양식을 사용하여 한 사용자에게서 다른 사용자에게 편집 재할당하기',
