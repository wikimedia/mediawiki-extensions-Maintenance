...
* Anything returned by the [[mw:Manual:Hooks/isValidPassword|isValidPassword]] hook.',
	...
	'maintenance-initStats-desc' => 'Used as description',
...
Hledám chybná přesměrování',
	...
	'maintenance-stats-articles' => 'Počet stránek ve hlavním jmenném prostoru: $1',
	'maintenance-stats-pages' => 'Počet stránek: $1',
	'maintenance-stats-users' => 'Počet uživatelů: $1',
...
Prüfung auf fehlerhafte Weiterleitungen …',
	...
	'maintenance-clear_interwiki_cache' => 'Diese Maske nutzen, um den Interwikicache vollständig zu löschen',
	'maintenance-clear_interwiki_cache-desc' => 'Alle Interwikilinks für alle Sprachen aus dem Cache entfernen',
...
$messages['diq'] = array(
	...
	'maintenance-stats-admins' => 'Amariya xizmetkaran: $1',
...
Comprobando las redirecciones erróneas...',
	...
	'maintenance-clear_interwiki_cache' => 'Utilice este formulario para borrar completamente la memoria caché de interwikis',
	'maintenance-clear_interwiki_cache-desc' => 'Borrar todos los enlaces interwiki para todos los idiomas de la memoria caché',
...
Recherche des mauvaises redirections...',
	...
	'maintenance-clear_interwiki_cache' => 'Utilisez ce formulaire pour vider complètement le cache interwiki',
	'maintenance-clear_interwiki_cache-desc' => 'Supprimer tous les liens interwiki pour toutes les langues dans le cache',
...
Finite.',
	...
	'maintenance-clear_interwiki_cache' => 'Usa iste formulario pro rader completemente le cache interwiki',
	'maintenance-clear_interwiki_cache-desc' => 'Eliminar tote le ligamines interwiki pro tote le linguas del cache',
...
完了。',
	...
	'maintenance-clear_interwiki_cache' => 'このフォームを使用してウィキ間キャッシュを完全に消去する',
	'maintenance-clear_interwiki_cache-desc' => 'キャッシュから全言語のウィキ間リンクをすべて消去する',
	...
	'maintenance-initStats' => 'このフォームを使用してサイト統計を再計算する。ページビュー数も再計算する場合は指定',
	...
	'maintenance-stats-desc' => 'メモリ内にキャッシュされた統計を表示する',
	...
	'maintenance-stats-update' => 'データベースを更新中{{int:ellipsis}}',
...
$messages['ka'] = array(
	...
	'maintenance-stats-pages' => 'გვერდების რაოდენობა: $1',
	'maintenance-stats-users' => 'მომხმარებლების რაოდენობა: $1',
	'maintenance-stats-admins' => 'ადმინისტრატორების რაოდენობა: $1',
	'maintenance-stats-images' => 'ფაილების რაოდენობა: $1',
...
Проверувам дали има лоши пренасочувања...',
	...
	'maintenance-clear_interwiki_cache' => 'Послужете се со овој образец за наполно исчистите кешот во меѓувики',
	'maintenance-clear_interwiki_cache-desc' => 'Чистење на сите меѓувики-врски на сите јазици од кешот',
...
Trwa sprawdzanie niepoprawnych przekierowań...',
	...
	'maintenance-clear_interwiki_cache' => 'Ten formularz służy do całkowitego wyczyszczenia pamięci podręcznej interwiki',
	'maintenance-clear_interwiki_cache-desc' => 'Wyczyść wszystkie łącza innych wiki dla wszystkich języków z pamięci podręcznej',
...
Le descrission a son tacà a minca senari",
	...
	'maintenance-error-badargs' => "It l'has pa specificà tute le opsion obligatòrie",
	...
	'maintenance-cleanupTable-dry-run' => 'Fà viré për preuva',
	'maintenance-cleanupTable-check' => 'Controlé it tìtoj pa bon...',
	'maintenance-cleanupTable-checkfix' => 'Controlé e coregi ij tìtoj pa bon...',
	...
	'maintenance-option-quiet' => 'Soprim scriture pa erà',
	'maintenance-option-globals' => 'Scriv ij globaj a la fin dël tratament për debug',
	'maintenance-option-confirm' => 'Conferma',
	'maintenance-option-batch-size' => 'Fà viré tute ste operassion për batch, predefinì: $1',
	'maintenance-option-required' => '(ciamà)',
	'maintenance-option-optional' => '(opsional)',
	'maintenance-output-success' => "$1 a l'ha girà da bin!",
	'maintenance-output-failure' => "$1 a l'ha pa virà da bin!",
	'maintenance-attachLatest' => "Dòvra sto formolari për coregi le vos ant la tàula dla pagina anté page_latest a l'é ampostà a 0",
	'maintenance-attachLatest-desc' => 'Coregg le vos page_latest ant la tàula dla pagina',
	'maintenance-attachLatest-option-fix' => 'Coregg efetivament le vos, dësnò a vireran për preuva',
	'maintenance-attachLatest-output-begin' => 'Serché pagine con page_latest ampostà a 0...',
	'maintenance-attachLatest-output-notime' => "$1 $2 [[$3]] as peul pa trovess l'ora dl'ùltima rev?",
	'maintenance-attachLatest-output-norev' => "$1 $2 [[$3]] ùltima vira $4, as peul pa trovesso l'id revision",
	'maintenance-attachLatest-output-found' => '$1 $2 [[$3]] ùltima vira $4, rev id $5',
	'maintenance-attachLatest-output-done' => 'Fàit! Tratà $1 {{PLURAL:$1|pagina|pagine}}.',
	'maintenance-attachLatest-output-dryrun' => 'Cost a l\'é un vir ëd preuva; falo torna viré con "{{int:maintenance-attachLatest-option-fix}}" për modifiché page_latest.',
	'maintenance-benchmarkPurge' => 'Dòvra sto formolari për prové vàire temp a duro le funsion ëd purga Squid',
	'maintenance-benchmarkPurge-desc' => 'Vàluta le funsion ëd purga Squid',
	...
	'maintenance-benchmarkPurge-output-numsquids' => 'A-i son $1 definì Squid {{PLURAL:$1|sërvent}}:',
	...
	'maintenance-checkAutoLoader' => 'Dòvra sto formolari për fé quaich contròj ëd salute dzor Autoloader',
	'maintenance-checkAutoLoader-desc' => "Contròj ëd salute d'Autoloader",
	'maintenance-checkAutoLoader-output-list2' => '$1: Archivi pa bon: trovà an $2, listà an $3',
	'maintenance-checkBadRedirects' => 'Dòvra sto formolari për vëdde se le pagine marcà con rediression a son pròpi rediression',
	'maintenance-checkBadRedirects-desc' => 'Contròla për rediression pa bon-e',
	'maintenance-checkBadRedirects-output-header' => 'Trové rediression...',
	'maintenance-checkBadRedirects-output-found' => 'Trovà $1 {{PLURAL:$1|rediression}}.
Controlé për rediression pa bon-e...',
	'maintenance-checkBadRedirects-output-footer' => 'Fàit.',
	'maintenance-checkImages' => 'Dòvra sto formolari për vëdde che figure dzo toa wiki a son pa bon-e',
	'maintenance-checkImages-desc' => "Contròla figure për vëdde s'a esisto, s'a son lesible, etc",
	'maintenance-checkImages-output-noaccess' => '$1: pa acessibla localment',
	'maintenance-checkImages-output-missing' => '$1: mancant',
	'maintenance-checkImages-output-isdir' => "$1: a l'é na cartela",
	'maintenance-checkImages-output-truncated' => "$1: truncà, a l'era $2",
	'maintenance-checkImages-output-mismatch' => '$1: dimension cosrispond pa DB=$2, vera=$3',
	'maintenance-checkImages-output-good' => 'Figure bon-e: $1/$2',
	'maintenance-checkSyntax' => "Dòvra sto formolari për controlé la sintass ëd tùit j'archivi PHP an MediaWiki",
	'maintenance-checkSyntax-desc' => "Contròla la sintass ëd tùit j'archivi PHP an MediaWiki",
	'maintenance-checkSyntax-option-with-extensions' => "Ëdcò ricorsivament an sla cartela d'estension",
	'maintenance-checkSyntax-option-path' => "Përcors specìfich (archivi o cartela) da controlé, o con ël përcors assolut o relativ a la radis dl'istalassion MediaWiki",
	'maintenance-checkSyntax-option-list-file' => "Lista d'archivi o cartele da controlé",
	'maintenance-checkSyntax-option-modified' => "Contròla mach j'archivi ch'a son stàit modificà (a veul un client svn a riga ëd comand)",
	'maintenance-checkSyntax-option-syntax-only' => "Contròla mach la validità dla sintass, sàuta j'avis dë stil ëd codìfica",
	'maintenance-checkSyntax-output-parsekit' => 'Contolé la sintass (dovrand parsekit)',
	'maintenance-checkSyntax-output-phpl' => 'Controlé la sintass (dovrand php -l, sòn a peul pijé motobin ëd temp)',
	'maintenance-checkSyntax-output-footer' => 'Fàit! $1 archivi controlà, trovà $2 faliment e $3 avis',
	'maintenance-checkSyntax-output-svnlist' => 'Arcuperé lista da Sotvërsion...',
	'maintenance-checkSyntax-output-buildlist' => "Creé lista dj'archivi...",
	...
	'maintenance-checkSyntax-error-nofile' => "Eror: as peul pa trovesse l'archivi o la cartela $1",
	'maintenance-checkSyntax-error-cantopen' => "As peul pa deurbse l'archivi $1",
	'maintenance-checkSyntax-error-svnerr' => 'Eror arcuperand la lista da Sotvërsion!',
	'maintenance-checkUsernames' => "Dòvra sta forma për mosté che nòm utent a son pa bon a causa ëd cangiament ëd configurassion. Se a l'é pa listà gnente d'apress d'avèj fàit viré lë script, tùit ij nòm utent a son bon",
	'maintenance-checkUsernames-desc' => 'Verifica che ij nòm utent dël database a sio efetivament bon',
	'maintenance-checkUsernames-error-notvalid' => 'Nòm utent pa bon: "$3" (id utent $2)',
	'maintenance-cleanupCaps' => 'Dòvra sto formolari për coregi dle pagine brecà causà dal modifiché $wgCapitalLinks',
	'maintenance-cleanupCaps-desc' => 'Script për polidé ël maiuscolin',
	'maintenance-cleanupCaps-option-namespace' => 'Nùmer dë spassi nominaj da feje viré dzora la polissìa dël maiuscolin',
	'maintenance-cleanupCaps-output-islower' => '"$1" già minuscolin.',
	'maintenance-cleanupCaps-output-clash' => '"$1" sautà; "$2" a esist già',
	'maintenance-cleanupCaps-output-dryrun' => '"$1" -> "$2": VIR ËD PREUVA, PA TRAMUDÀ',
	'maintenance-cleanupCaps-error-noneed' => '$wgCapitalLinks a l\'é anvisch -- a-i è pa dabzògn dla polissìa dij colegament maiuscolin.',
	'maintenance-cleanupSpam' => 'Dòvra sto formolari për anulé le modìfiche dë spam che a colego sit estern',
	'maintenance-cleanupSpam-desc' => 'Polida tut lë spam da un nòm host dàit',
	'maintenance-cleanupSpam-option-hostname' => "Nòm host che a l'ha fàit spamming",
	...
	'maintenance-cleanupSpam-output-blanking' => 'dësvoidé',
	'maintenance-cleanupSpam-output-reverting' => 'anulé',
	'maintenance-cleanupSpam-error-invalid' => "Pa na specificassion d'un nòm host bon: $1",
	'maintenance-cleanupSpam-error-noid' => "Eror antern: gnun-e pagine për l'ID $1",
	'maintenance-clear_interwiki_cache' => 'Dòvra sto formolari për canselé completament la memòria antërwiki',
	'maintenance-clear_interwiki_cache-desc' => 'Cansela tùit ij colegament antërwiki për tute le lenghe da la memòria',
...
Marché la casela mangiapapé s'a veul ëdcò promeuvlo a mangiapapé",
	...
	'maintenance-createAndPromote-error-password' => "A l'é ancontrasse n'eror con la ciav ch'it l'has anserì: $1",
...
Minca linia a dovrìa spessifiché na pàgina sorgiss e na pàgina destinassion separà da na bara vertical',
	...
	'maintenance-runJobs-option-maxjobs' => 'Màssim nùmer ëd travaj da fé viré',
	'maintenance-runJobs-option-type' => 'Sòrt ëd travaj da fé viré',
	'maintenance-runJobs-option-procs' => 'Nùmer ëd process da dovré',
	'maintenance-runJobs-option-exclusive' => "Fà viré mach në script runJobs esclusiv për vòta. Timeout a l'é 1800 second.",
	'maintenance-runJobs-error-invalidprocs' => 'It deuve specifiché tra 1 e 1000 process',
	'maintenance-showJobs-desc' => 'Smon-e na lista dij travajòt an cors ant la coa dij travajòt',
	'maintenance-showJobs-option-group' => 'Mosta ël nùmer ëd travaj për sòrt ëd travaj',
	...
	'maintenance-sql-output-aff' => 'Query OK, $1 {{PLURAL:$1|riga|righe}} agiornà',
	'maintenance-sql-error-cantopen' => "As peul pa dorbisse l'archivi d'anseriment",
...
$messages['si'] = array(
	...
	'maintenance-stats-admins' => 'පරිපාලකවරුන් සංඛ්‍යාව: $1',
	'maintenance-stats-images' => 'ගොනු සංඛ්‍යාව: $1',
	'maintenance-stats-views' => 'පිටුනැරඹුම් සංඛ්‍යාව: $1',
	'maintenance-stats-update' => 'දත්ත සංචිතය යාවත්කාලීන කරමින්{{int:ellipsis}}',
...
$messages['ta'] = array(
	...
	'maintenance-stats-update' => 'தரவுத் தளத்தை இற்றைப்படுத்துகின்றது{{int:ellipsis}}',
...
Nagsisiyasat ng masasamang mga pagpapapunta sa ibang pahina...',
	...
	'maintenance-clear_interwiki_cache' => 'Gamitin ang pormularyong ito upang mahawi ng buo ang taguan ng ugnayang-wiki',
	'maintenance-clear_interwiki_cache-desc' => 'Hawiin ang lahat ng mga kawing ng ugnayang-wiki para sa lahat ng mga wiki mula sa taguan',
...
完成。',
	...
	'maintenance-stats-edits' => '編輯次數：$1',
